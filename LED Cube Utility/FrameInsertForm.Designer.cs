namespace LED_Cube_Utility {
	partial class FrameInsertForm {
		...
		private void InitializeComponent() {
			...
			this.label1.Text = "Insert frame at which index?";
			...
			this.Name = "FrameInsertForm";
			this.Text = "FrameInsertForm";
